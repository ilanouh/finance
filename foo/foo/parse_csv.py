...
class		AccountAnalytics(object):
		...
		account_p = models.CharField(max_length=250)
		account_perf = models.CharField(max_length=250)
		account_vol = models.CharField(max_length=250)
		accound_maxdd = models.CharField(max_length=250)
		account_te = models.CharField(max_length=250)
		bench_p = models.CharField(max_length=250)
		bench_perf = models.CharField(max_length=250)
		bench_perfann = models.CharField(max_length=250)
		bench_vol = models.CharField(max_length=250)
		bench_maxdd = models.CharField(max_length=250)
